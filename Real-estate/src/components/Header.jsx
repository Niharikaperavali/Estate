...
const Header = () => {
  return (
    ...
    items-center w-ful overflow-hdden' style=
    {{backgroundImage:"url('/header_img.png)"}} id='Header'>
     <Navbar/>
     <div className='container text-center nx-auto py-4 px-6 md:px-20 
     lg:px-32 text-white'>
        ...
        <div className='space-x-6 mt-16'>
            ...
            rouded'>Projects</a>
            <a href="#Contact" className='border border-white px-8 py-3 
            rouded'>Contact us</a>
